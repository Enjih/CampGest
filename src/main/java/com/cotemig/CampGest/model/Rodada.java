...
public class Rodada {
	...
	public Campeonato getCampeonato_rodada() {
		return campeonato_rodada;
	}

	public void setCampeonato_rodada(Campeonato campeonato_rodada) {
		this.campeonato_rodada = campeonato_rodada;
	}
